        ...
        <template #tbody>
          <div v-for="persons in SearchFilter" :key="persons.id" class="w-full relative">
              ...
              <Tr :nom="persons.nom" :prenom="persons.prenom" :poste="persons.poste" :salaire="persons.salaire" :statut="persons.statut">
                  <template #option>
                      <svg @click="OptionModal(persons.id)" xmlns="http://www.w3.org/2000/svg" class="h-5 w-5 dark:stroke-blue-600" fill="none" viewBox="0 0 24 24" stroke="currentColor" stroke-width="2">
